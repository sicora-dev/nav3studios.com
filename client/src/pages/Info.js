          ...
          <div className="m-auto grid grid-cols-1 gap-10 pb-20 xl:grid-cols-2">
            {[1, 2].map((id) => (
              <div
                ...
                className="relative flex h-full max-w-md overflow-hidden rounded-md border border-light-text bg-gradient-to-b from-light-background to-light-secondary px-8 py-8 shadow-2xl transition-all duration-500 ease-in-out hover:max-h-[1200px] xl:max-h-[460px] dark:border-dark-secondary dark:from-dark-background dark:to-dark-secondary"
              >
                <input
                  aria-hidden="true"
                ...
                {id === 1 && (
                  <article className="relative flex flex-col content-center items-center gap-2">
                    <img
                      ...
                      className="card h-auto max-h-96 w-auto transform rounded-md bg-light-buttons"
                      alt="imagen najera"
                    />
                ...
                {id === 2 && (
                  <article className="relative flex flex-col items-center gap-2">
                    ...
                    <p className="w-full">
                      ...
                      <span className="text-light-buttons"> de vida</span> a
                      esas melodías que no puedes sacarte de la cabeza , esas
                      que tarareas una y otra vez sin darte cuenta, o permítele
